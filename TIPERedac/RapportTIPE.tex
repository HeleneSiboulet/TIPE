...
\includegraphics[width=0.48 \textwidth]{/Users/helene/Documents/TIPE/TIPERedac/imagesTIPE/humidite.png}
\caption{\label{fig:190101Lolita} Courbes de température et d'humdité de la base d'apprentissage : Clermont-Ferrand}
\end{figure}

Comment estimer la valeur d'un ensemble de prévisions~? On calcule l'écart type entre nos prévisions et les températures mesurées. cela permet d'estimer la valeur des prévisions, mais à condition d'avoir une valeur de comparaison. Nous utilisons pour cette valeur les diférences entre les quartiles 1 et 3. \\ Calcul des Quartiles de l'humidité et de la température. En dessous du premier quartile, on trouve le quart des valeurs, et au dessus du troisième quartile, on trouve un quart des valeurs.\\ 
...
Température&$Q1 = 6.39{}^{\circ}C$&$Q3 = 17.4{}^{\circ}C$&soit un intervalle de $11{}^{\circ}C $\\
...
\begin{figure} [!h]
\centering
\includegraphics[width=0.48 \textwidth]{/Users/helene/Documents/TIPE/TIPERedac/imagesTIPE/moyenneT.png}\quad
\includegraphics[width=0.48 \textwidth]{/Users/helene/Documents/TIPE/TIPERedac/imagesTIPE/moyenneH.png}
...
\begin{figure} [!h]
\centering
\includegraphics[width=0.48 \textwidth]{/Users/helene/Documents/TIPE/TIPERedac/imagesTIPE/fftT.png}\quad
\includegraphics[width=0.48 \textwidth]{/Users/helene/Documents/TIPE/TIPERedac/imagesTIPE/fftH.png}
\caption{\label{fig:190101Lolita} Transformation de Fourier de la température et de l'humidité de la base d'entrainement (auquelles ont a enlevé la valeur moyenne moins un)}
\end{figure}
